...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <a class="navbar-brand" href="index.html">BuyStyle</a>
                    ...
                    <div  class="container-fluid text-center" id="contact" style="background-image: url('Images/bb.png'); padding-top: 20px;">
                        <div class="row">
                            ...
                            <form class="" action="#" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="col-1"><br>
                                <button class="btn btn-warning" type="submit" style="padding:10px 40px 10px 40px; border: solid gray 1px;" name="productinsert" data-toggle="modal" data-target="#query"><b>Insert</button>
                                </div>
                              </div>
                            </div>
                            </form> 
    ...
    <footer class="py-4 bg-light mt-auto">
                    <div class="container-fluid">
                        <div class="d-flex align-items-center justify-content-between small">
                            <div class="text-muted">Copyright &copy; BuyStyle 2020</div>
                        </div>
                    </div>
                </footer>
            </div>
